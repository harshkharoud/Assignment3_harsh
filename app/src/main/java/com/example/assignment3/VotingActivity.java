        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(inputName.getText().toString().isEmpty()){
                    Toast.makeText(VotingActivity.this, "Name field", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(inputId.getText().toString().isEmpty()){
                    Toast.makeText(VotingActivity.this, "Id field", Toast.LENGTH_SHORT).show();
                    return;
                }

                for (Voter V : voters) {
                    if(V.getId() == Integer.parseInt(inputId.getText().toString())){
                        Toast.makeText(VotingActivity.this, "Id is already present", Toast.LENGTH_SHORT).show();
                        return;
                    }
                }
                
                if(!toggleButton.isChecked()){
                    Toast.makeText(VotingActivity.this, "Please accept the terms and conditions", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                Toast.makeText(VotingActivity.this, "You have successfully casted a vote!", Toast.LENGTH_SHORT).show();
